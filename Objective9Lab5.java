    ...
    System.out.println("Please enter a second number: ");
      ...
      while (keepGoing) {
        ...
        switch (choice) {
          ...
          System.out.println("The amount of tax to be collected from a purchase of " + num1 + " and " + num2 + " = $" + (tax));
          break;
          case 4:
          keepGoing = false;
          ...
          break;
          default:
          System.out.println("Sorry that is an invalid choice. Please choose from the menu options");
        }
        }
